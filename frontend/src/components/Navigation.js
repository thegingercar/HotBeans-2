      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/apply">
              <motion.button
                className="bg-gradient-to-r from-green-600 to-teal-500 text-white px-6 py-2 rounded-full font-semibold hover:shadow-lg transition-all duration-200"
        ...
        {isOpen && (
          ...
          >
            ...
            <Link to="/apply">
              <button
                className="w-full bg-gradient-to-r from-green-600 to-teal-500 text-white px-6 py-2 rounded-full font-semibold mt-4 hover:shadow-lg transition-all duration-200"
